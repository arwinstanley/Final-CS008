...
if (isset($_POST["btnSubmit"])) {
    ...
    if (!$errorMsg) {
        ...
        $message = $_POST['txtFirstName'] . ",<br>Thank you for adopting a Sea Otter!";
        $message .= "<br>";
...
// to display the form.
        ...
        if (isset($_POST["btnSubmit"]) AND empty($errorMsg)) { // closing of if marked with: end body submit
            print '<h1>Thank you for adopting!</h1>';
        ...
        print PHP_EOL . '<!-- SECTION 3c html Form -->' . PHP_EOL;
            ...
            <form action = "<?php print $phpSelf; ?>"
                ...
                <input type="checkbox" checked="checked">By adopting you agree to our<a href="terms.php">Terms & Privacy</a>.</p>   
